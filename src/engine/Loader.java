...
public class Loader {
	 ...
	 *            - The number of the attribute of the VAO where the data is to be stored.
	 * @param coordinateSize
	 * 			  - The amount
	 * @param data
	 *            - The geometry data to be stored in the VAO, in this case the positions of the vertices.
	 */
	 ...
	 * @return The FloatBuffer containing the data. This float buffer is ready to be loaded into a VBO.
	 */
